    ...
    if editing_mode:
        ...
        if results:
            yield [
                ...
                "Cars on this street: " + str(len(results[0])), 
                hour_frame
            ]
...
with gr.Blocks() as demo:
    ...
    frame = gr.Image(height=200, width=300)
    ...
    editing.click(switch_editing_mode, None, [rotation_slider, w_begin_slider, w_dif_slider, h_begin_slider, h_dif_slider])
